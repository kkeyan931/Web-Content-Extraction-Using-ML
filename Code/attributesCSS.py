cssKeyword = ["Property", "align-content", "align-items", "align-self", "animation",
              ...
              "box-shadow", "box-sizing", "caption-side", "clear", "clip", "color", "column-count",
              ...
              "counter-reset", "cursor", "direction", "display", "empty-cells", "flex", "flex-basis",
              ...
              "min-height", "min-width", "opacity", "order", "outline", "outline-color", "outline-offset",
              ...
              "transition-property", "transition-timing-function", "vertical-align", "visibility", "white-space",
